...
export default function PrivacyPolicy() {
  return (
    <LegalPage title="Privacy Policy">
      <div>
        <h2 className="text-xl">PRIVACY NOTICE</h2>
        <p>Last updated: 19/02/2023</p>
        <p>
          This privacy notice for Anglez Ltd. ("Company," "we," "us," or "our"),
          ...
          us at support@anglez.io.
        </p>

        <h2 className="text-xl">SUMMARY OF KEY POINTS</h2>
        <p className="italic">
        ...
        <p>
          ...
          on how you interact with anglez.io and the Services, the choices you
        ...
        <p>
          Want to learn more about what anglez.io does with any information we
        ...
        <ol>
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/privacy-policy#do-california-residents-have-specific-privacy-rights"
            >
        ...
        <h2 id="what-information-do-we-collect" className="text-xl">
          1. WHAT INFORMATION DO WE COLLECT?
        </h2>
        <h3 className="text-lg">Personal information you disclose to us</h3>
        ...
        <h3 className="text-lg">Information automatically collected</h3>
        <p>
          n Short: Some information — such as your Internet Protocol (IP)
        ...
        <h2 id="how-do-we-process-your-information" className="text-xl">
        ...
        <h2 id="how-do-we-handle-your-social-logins" className="text-xl">
        ...
        <h2 id="how-long-do-we-keep-your-information" className="text-xl">
        ...
        <h2 id="do-we-collect-information-from-minors" className="text-xl">
        ...
        <p>
          ...
          please contact us at support@anglez.io.
        </p>

        <h2 id="what-are-your-privacy-rights" className="text-xl">
        ...
        <h2 id="controls-for-do-not-track-features" className="text-xl">
        ...
        <h2 id="do-we-make-updates-to-this-notice" className="text-xl">
        ...
        <h2 id="how-can-you-contact-us-about-this-notice" className="text-xl">
          13. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?
        </h2>
        <p>
          If you have questions or comments about this notice, you may email us
          at support@anglez.io or by post to:
        </p>
        <p>
          Anglez Ltd.
          <br />
        ...
        <p>
          ...
          or delete your personal information, please submit a request by
          emailing us at support@anglez.io.
        </p>
      </div>
    </LegalPage>
  );
