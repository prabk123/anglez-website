  ...
  return (
    <LegalPage title="Terms & Conditions">
      <div className="scroll-pt-96">
        <h2 className="text-xl">AGREEMENT TO OUR LEGAL TERMS</h2>
        <p>
          We are Anglez Ltd., doing business as anglez.io ("Company," "we,"
          "us," "our"), a company registered in the United Kingdom at 6
          Kelmscott Road, London SW116QY.
        </p>
        <p>
          We operate the website https://anglez.io (the "Site"), as well as any
          other related products and services that refer or link to these legal
          terms (the "Legal Terms") (collectively, the "Services").
        </p>
        <p>
          You can contact us by email at support@anglez.io, or by mail to 6
          Kelmscott Road, London SW116QY, United Kingdom.
        </p>
        <p>
          These Legal Terms constitute a legally binding agreement made between
          you, whether personally or on behalf of an entity ("you"), and Anglez
        ...
        <ol>
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#intellectual-property-rights"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#user-representations"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#prohibited-activities"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#user-generated-contributions"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#contribution-license"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#guidelines-for-reviews"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#third-party-website-and-content"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#services-management"
            >
              SERVICES MANAGEMENT
            </NavLink>
          </li>
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#modifications-and-interruptions"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#limitations-of-liability"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#electronic-communications-transactions-and-signatures"
            >
          ...
          <li>
            <NavLink
              className="text-base text-gray-500"
              href="/terms#california-users-and-residents"
            >
        ...
        <h2 id="our-services" className="text-xl">
          1. OUR SERVICES
        </h2>
        <p>
        ...
        <h2 id="intellectual-property-rights" className="text-xl">
          2. INTELLECTUAL PROPERTY RIGHTS
        </h2>
        <h3 className="text-lg">Our intellectual property</h3>
        <p>
        ...
        <h3 className="text-lg">Your use of our Services</h3>
        <p>
        ...
        <p>
          ...
          please address your request to: support@anglez.io. If we ever grant
        ...
        <h3 className="text-lg">Your submissions</h3>
        <p>
        ...
        <h2 id="user-representations" className="text-xl">
        ...
        <h2 id="user-registration" className="text-xl">
          4. USER REGISTRATION
        </h2>
        <p>
        ...
        <h2 id="purchases-and-payments" className="text-xl">
        ...
        <h2 id="free-trial" className="text-xl">
          6. FREE TRIAL
        </h2>
        <p>
        ...
        <h2 id="cancellation" className="text-xl">
          7. CANCELLATION
        </h2>
        <p>
        ...
        <h2 id="prohibited-activities" className="text-xl">
        ...
        <h2 id="user-generated-contributions" className="text-xl">
        ...
        <h2 id="contribution-license" className="text-xl">
        ...
        <h2 id="guidelines for reviews" className="text-xl">
        ...
        <h2 id="third-party-websites-and-content" className="text-xl">
        ...
        <h2 id="services-management" className="text-xl">
        ...
        <h2 id="privacy-policy" className="text-xl">
          14. PRIVACY POLICY
        </h2>
        <p>
          We care about data privacy and security. Please review our Privacy
          Policy: https://anglez.io/privacy-policy. By using the Services, you
          ...
          United States, then through your continued use of the Services, you
        ...
        <h2 id="term-and-termination" className="text-xl">
        ...
        <h2 id="modifications-and-interruptions" className="text-xl">
        ...
        <h2 id="governing-law" className="text-xl">
          17. GOVERNING LAW
        </h2>
        <p>
          ...
          provisions of the law in your country to residence. Anglez Ltd. and
        ...
        <h2 id="dispute-resolution" className="text-xl">
          18. DISPUTE RESOLUTION
        </h2>
        <p>
          The European Commission provides an online dispute resolution
          platform, which you can access here:
          https://ec.europa.eu/consumers/odr. If you would like to bring this
          subject to our attention, please contact us.
        </p>

        <h2 id="corrections" className="text-xl">
          19. CORRECTIONS
        </h2>
        <p>
        ...
        <h2 id="disclaimer" className="text-xl">
          20. DISCLAIMER
        </h2>
        <p>
        ...
        <h2 id="limitations-of-liability" className="text-xl">
        ...
        <h2 id="indemnification" className="text-xl">
          22. INDEMNIFICATION
        </h2>
        <p>
        ...
        <h2 id="user-data" className="text-xl">
          23. USER DATA
        </h2>
        <p>
        ...
        <h2 id="california-users-and-residents" className="text-xl">
        ...
        <h2 id="miscellaneous" className="text-xl">
          26. MISCELLANEOUS
        </h2>
        <p>
        ...
        <h2 id="contact-us" className="text-xl">
          27. CONTACT US
        </h2>
        <p>
